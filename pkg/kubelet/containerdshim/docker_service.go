...
import (
	...
	"k8s.io/kubernetes/pkg/kubelet/containerdshim/cm"
	"k8s.io/kubernetes/pkg/kubelet/containerdshim/errors"
...
const (
	...
	// containerdshimRootDir is the root directory for containerdshim
	containerdshimRootDir = "/var/lib/containerdshim"
	...
	// containerdshim should provide detection support for a remapping environment .
...
func NewDockerService(client dockertools.DockerInterface, seccompProfileRoot string, podSandboxImage string, streamingConfig *streaming.Config,
	...
	// containerdshim currently only supports CNI plugins.
